...
"""Module for the CONNECT model for the information cascade task."""
...
class CONNECT(LightningModule):
    """The CONNECT model for the information cascade task."""
...
def train(config: dict[str, Any], mode: Literal["micro", "macro"]) -> None:
    """Trains the CONNECT model for the information cascade task."""
    if "seed" in config:
...
def test(config: dict[str, Any], mode: Literal["micro", "macro"]) -> None:
    """Tests the CONNECT model for the information cascade task."""
    if "seed" in config:
        utils.seed_all(config["seed"])
