...
class GraphAttentionEmbedder(Module, Embedder):
    ...
    def get_neighborhoods(
        ...
        neighborhoods = []
        for it in range(len(self.layers)):
    ...
    def __call__(
        ...
        return self._compute(state, idx, t, neighborhoods, 0)
    ...
    def _compute(
        ...
        return self.layers[depth](q, q_time, kv, kv_time, kv_event, mask)
