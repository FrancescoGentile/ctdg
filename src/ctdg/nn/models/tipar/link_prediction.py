...
"""Module for the TIPAR model for the link prediction task."""
...
class TIPAR(LightningModule):
    """A lightning module for the link prediction task using the TIPAR model."""
...
def train(config: dict[str, Any]) -> None:
    """Trains the TIPAR model for the link prediction task."""
    if "seed" in config:
...
def test(config: dict[str, Any]) -> None:
    """Tests the TIPAR model for the link prediction task."""
    if "seed" in config:
        utils.seed_all(config["seed"])
