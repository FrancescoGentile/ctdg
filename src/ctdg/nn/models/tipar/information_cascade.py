...
"""Module for the TIPAR model for the information cascade task."""
...
from ._model import TIPAR as _TIPAR


class TIPAR(LightningModule):
    """The TIPAR model for the information cascade task."""
...
def train(config: dict[str, Any], mode: Literal["micro", "macro"]) -> None:
    """Trains the TIPAR model for the information cascade task."""
    if "seed" in config:
...
def test(config: dict[str, Any], mode: Literal["micro", "macro"]) -> None:
    """Tests the TIPAR model for the information cascade task."""
    if "seed" in config:
        utils.seed_all(config["seed"])
