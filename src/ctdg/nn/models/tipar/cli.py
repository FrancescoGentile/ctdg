...
"""Coomand line interface for the TIPAR model."""
...
def init_parser(parser: argparse.ArgumentParser) -> None:
    """Initializes the parser for the TIPAR model."""
    parser.description = "Temporal Information Propagation through Adaptive Rewiring"
    parser.add_argument(
        "--task",
        type=str,
