...
"""Module for the TGN model for the link prediction task."""
...
class TGN(LightningModule):
    """The TGN model for the link prediction task."""
...
def train(config: dict[str, Any]) -> None:
    """Trains the TGN model for the link prediction task."""
    if "seed" in config:
...
def test(config: dict[str, Any]) -> None:
    """Tests the TGN model for the link prediction task."""
    if "seed" in config:
        utils.seed_all(config["seed"])
